...
>(({ className, children, size = "md", ...props }, ref) => {
  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-xl p-1.5 text-muted-foreground opacity-70 transition-opacity hover:opacity-100 hover:bg-muted focus:outline-none focus:ring-2 focus:ring-sky-400 cursor-pointer">
          <X className="h-4 w-4" />
...
// Modal naming aliases for backward compatibility with Design System
